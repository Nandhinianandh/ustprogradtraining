...
public class NoteKeeperTest {
    ...
    public void toggleCompletedAndNotCompleted() {
        ...
        ArrayList<String> expectedAnswer = new ArrayList<>(List.of("Science Class-NotCompleted", "Science Homework-NotCompleted","Maths Class-NotCompleted","Assignment-NotCompleted"));
        assertEquals(expectedAnswer, answer);
    }
}
